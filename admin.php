...
<body>
   ...
   <nav>
    ...
    <main>
        ...
        <h1>Security Of Credentials Information</h1>
        <p>
            Welcome to the Security Panel. As an <span class="highlight">Admin</span>, We are responsible for managing the website, overseeing operations, and ensuring a smooth user experience.
        </p>
        <p>
            Our duties include monitoring system performance, managing user data, and ensuring compliance with platform policies. 
        </p>
        
        <!-- Security Information Section -->
        <div class="security-info">
            <h3>Security of User Information</h3>
            <p>
                As an admin, it is essential to prioritize the <span class="highlight">security</span> of user information. Our platform employs advanced security protocols to ensure that sensitive data is protected at all times.
            </p>
            <p>
                We utilize <strong>SSL encryption</strong> to safeguard data during transmission. Additionally, all user passwords are stored using <strong>hashing algorithms</strong> to prevent unauthorized access.
            </p>
            <p>
                Regular security audits and vulnerability testing are conducted to identify and address potential risks. We also comply with data protection regulations to maintain the confidentiality and integrity of user information.
            </p>
        </div><br>
         <div class="login-btn">
